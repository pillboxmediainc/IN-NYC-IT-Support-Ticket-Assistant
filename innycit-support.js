...
const tips = [
  { id: 01, title: "When in doubt, restart it", body: "It's often overlooked, but sometimes the best first course of action is to power cycle the device in question. It's often overlooked, but sometimes the best first course of action is to power cycle the device in question." },
  { id: 02, title: "title 02", body: "body 02" },
